    ...
    <Card className="card-hover">
      <CardHeader>
        <div className="flex items-center space-x-2">
          <Activity className="h-5 w-5 text-blox-teal" />
      ...
      <CardContent className="space-y-3">
        {recentActivities.map((activity) => {
          ...
          return (
            <div 
              key={activity.id}
              className="flex items-center space-x-3 p-3 rounded-lg bg-blox-second-dark-blue/30 hover:bg-blox-second-dark-blue/50 transition-all duration-200 group"
            >
              {/* Activity Icon */}
              <div className={`p-2 rounded-lg bg-blox-very-dark-blue ${activity.color}`}>
