...
CREATE TABLE IF NOT EXISTS public.videos (
  ...
  INDEX idx_videos_module_week (module_id, week_id),
...
CREATE TABLE IF NOT EXISTS public.video_transcripts (
  ...
  INDEX idx_video_transcripts_youtube_id (youtube_id),
...
CREATE TABLE IF NOT EXISTS public.video_transcript_chunks (
  ...
  -- Indexes
  INDEX idx_transcript_chunks_video_id (video_id),
  INDEX idx_transcript_chunks_youtube_id (youtube_id),
  INDEX idx_transcript_chunks_time (start_time, end_time),
  INDEX idx_transcript_chunks_text (text),
